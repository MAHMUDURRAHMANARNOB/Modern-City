...
float _moveca = 0.0f;///Blue and Yellow car
...
///car1_Finish
 ...
 ///Car2_Begin Blue
     glPushMatrix();
    glTranslatef(_moveca, +0.20f,0.0f );
    glPushMatrix();
    ///LBody///
    glBegin(GL_POLYGON);
    glColor3ub(la,lb,lc);
...
glPushMatrix();
    glBegin(GL_POLYGON);
     glColor3ub(200,100,0);
        glVertex2f(0.555f, 0.1f);
        glVertex2f(0.555f, 0.21f);
        glVertex2f(0.558f, 0.21f);
        glVertex2f(0.558f, 0.1f);
	glEnd();
    glPopMatrix();

///School line bottom to up
 glPushMatrix();
    glBegin(GL_POLYGON);
    glColor3ub(255,255,255);
    ...
    glColor3ub(0, 0,0 );
        ...
        glVertex2f(0.495f, 0.54f);
        glVertex2f(0.495f, 0.09f);
	glEnd();
    glPopMatrix();
...
glPushMatrix();
    glBegin(GL_POLYGON);
     glColor3ub(255,255,255);
        glVertex2f(0.007f, 0.375f);
        glVertex2f(0.007f, 0.383f);
        glVertex2f(0.31f, 0.383f);
        glVertex2f(0.31f, 0.375f);
	glEnd();
    glPopMatrix();
...
glPushMatrix();
    glBegin(GL_POLYGON);
     glColor3ub(255,255,255);
        ...
        glVertex2f(0.115f, 0.64f);
        glVertex2f(0.115f, 0.60f);
	glEnd();
    glPopMatrix();
...
glPushMatrix();
    glBegin(GL_POLYGON);
     glColor3ub(255,255,255);
        ...
        glVertex2f(0.215f, 0.64f);
        glVertex2f(0.215f, 0.60f);
	glEnd();
    glPopMatrix();
...
glPushMatrix();
    ...
    glColor3ub(98,78,44);
        ...
        glVertex2f(-0.035f, -0.39f);
        glVertex2f(-0.035f, -0.41f);
        glVertex2f(-0.05f, -0.5f);
        glVertex2f(-0.036f, -0.49f);
        glVertex2f(-0.03f, -0.5f);
        glVertex2f(-0.031f, -0.49f);
        glVertex2f(-0.007f, -0.5f);
        glVertex2f(-0.019, -0.41f);
        glVertex2f(-0.019, -0.39f);
        glVertex2f(-0.007f, -0.25f);
        glVertex2f(-0.013f, -0.25f);
...
mg=255;
 ...
 rc=102;
    ...
    break;
      ...
      // sndPlaySound("airHorn.wav",SND_MEMORY|SND_ASYNC);
        break;
      case 'g':
...
int main(int argc, char** argv) {
    ...
    cout << "Modern City"<< endl;

    cout << "Press a : To Speed Up the Red Car"  << endl;
    cout << "Press b : To Speed down the Red Car" << endl;
    cout << "Press c : To Speed Up the Train"  << endl;
    cout << "Press d : To Speed down the Train" << endl;
    cout << "Press e : For Night & Day Mode " << endl;
